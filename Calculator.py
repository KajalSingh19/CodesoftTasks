...
btn_Divison = tk.Button(root , text= "/" , command = lambda: add_to_calculation("/") , width=5, font = ("Arial" ,14) )
...
btn_equals = tk.Button(root , text= "=" , command = evaluate_calculate , width=11, font = ("Arial" ,14) )
